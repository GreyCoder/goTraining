...
// Write a table drive test for stings.Index
...
// Rewrite the above test for strings.Count using subtests
...
func Test_Index(t *testing.T) {
	...
	for _, x := range indexTable {
		got := strings.Index(x.Value, x.Substring)
		if got != x.Answer {
